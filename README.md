...
The Cricket Data Analytics🏏 project was made using the T-20 Cricket World Cup Data. I have used **Power BI** for making the Dashboard. We can easily analyze the data of the matches played in the world cup and also choose our best playing 11 from the pool of players playing the world cup. 

> To interact with the dashboard you can download the pbix file from the repository and open it in locally on Power BI Desktop.
